...
| `playbooks/provision/node-platform.yml` | `anixops_node_platform_servers` | AnixOps node platform web stack with internal API and Nginx edge proxy |
...
| [docs/ANIXOPS_NODE_PLATFORM.md](docs/ANIXOPS_NODE_PLATFORM.md) | AnixOps node platform stack template |
